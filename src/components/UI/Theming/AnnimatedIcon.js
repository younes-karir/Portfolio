...
const AnimatedIcon = (props) => {
  ...
  const toggleDarkMode = () => {
    ...
    if (isDarkMode) dispatch(ThemeToggleLight());
    else dispatch(ThemeToggleDark());

  };


  useEffect(() => {
    setDarkMode(thiming.title === "dark")
  }, [thiming])
  ...
  return (
    ...
    >
      ...
      <animated.circle
        ...
        mask="url(#myMask2)"
      />
      <animated.g stroke={thiming.colors.text} style={linesProps}>
